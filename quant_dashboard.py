...
with tab6:
    ...
    ETF_LIST = [
        # 삼성증권 HTS 기준 확인된 종목코드
        ("069500",  "KODEX 200",              "KS"),  # 코스피200 대표 지수
        ("133690",  "TIGER 나스닥100",        "KS"),  # 미래에셋 나스닥100
        ("091160",  "KODEX 반도체",           "KS"),  # 삼성 반도체 섹터
        ("395160",  "KODEX AI반도체TOP2+",    "KS"),  # 삼성 AI반도체 (삼성전자+하이닉스)
        ("329180",  "HD현대중공업",           "KS"),  # 조선 대표주 (ETF 대체)
        ("463250",  "TIGER K방산&우주",       "KS"),  # 미래에셋 방산
        ("459580",  "KODEX AI전력핵심설비",   "KS"),  # 삼성 AI전력 (2026 수익률 1위)
        ("411060",  "ACE KRX금현물",          "KS"),  # 한투 금현물
        ("042700",  "한미반도체",             "KS"),  # AI반도체 대표주
        ("012450",  "한화에어로스페이스",     "KS"),  # 방산 대표주
    ]
